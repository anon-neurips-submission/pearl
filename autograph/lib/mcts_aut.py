...
class MCTSAut(Generic[T]):
    ...
    def mcts_mini_batch(self, env: AutShapingWrapper, start_state: T, batch_size: int, lp_gen: bool) -> None:
        """
        ...
        if len(creates) > 0:
            ...
            # TODO: do we want to use LPNET during LP games or use randomNet ?
    ...
    def mcts_batch(self, env: AutShapingWrapper, state: Any, count: int, batch_size: int, lp_gen=False) -> None:
        """
        Run a batch of MCTS
